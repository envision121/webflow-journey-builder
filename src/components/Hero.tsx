...
const Hero = () => {
  ...
  return (
    <div className="relative h-[calc(100vh-7rem)] overflow-hidden">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-[60%] -translate-y-1/2 z-30 bg-white/10 hover:bg-white/20 p-2 rounded-full backdrop-blur-sm transition-all duration-300"
      >
        <ChevronLeft className="h-6 w-6 text-white" />
      </button>
      <button
        onClick={nextSlide}
        className="absolute right-4 top-[60%] -translate-y-1/2 z-30 bg-white/10 hover:bg-white/20 p-2 rounded-full backdrop-blur-sm transition-all duration-300"
      >
